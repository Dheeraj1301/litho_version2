  ...
  return (
    <div className="min-h-screen bg-slate-100 p-6 text-slate-900">
      <div className="mx-auto max-w-3xl rounded-2xl border border-red-200 bg-white p-6 shadow">
        <h1 className="text-2xl font-bold text-red-700">Frontend failed to render</h1>
        <p className="mt-3 text-sm text-slate-700">
          The React bundle loaded, but rendering failed. Check the browser console for the full error.
        </p>
...
try {
  ...
  console.error('Failed to render the React dashboard', error);
